...
public class PlusKeyBinding extends KeyBinding {



    public PlusKeyBinding() {
        super("key.mcreator.plus", GLFW.GLFW_KEY_V, "key.categories.misc");
    }
    ...
    public void plusAction(PlayerEntity playerEntity){
